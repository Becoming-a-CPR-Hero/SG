...
try {
  userName = localStorage.getItem("cprUserName") || "";
...
function handle_inactivity() {
    if (lastTouchElapsed > 4000) {
        ...
        lateaud.play();
        // logSession() now happens after the post-mission questionnaire
        // (postq1-7), from handlePostQ7Next, so it can include the
        // learner's answers and photo in the same log entry.
    }
}
...
// ========================================
// PROMISE SCREENS
// Shown after the post-mission questionnaire (postq1-7) is complete.
// Each helper reproduces the raja/rani reveal timing that used to run
// directly off each "next" button; showPromiseScreen() just picks the
// right one for whichever ending (currentState) the player reached.
// ========================================
...
function showPromiseScreen() {
    ...
    switch (currentState) {
        ...
        case "lateslow":
            ...
            break;
        default:
            console.warn("showPromiseScreen: unrecognized currentState:", currentState);
    }
}
...
function reset() {
  ...
  sessionLogged = false;
    ...
    // Reset pre/post-question answers and photo ahead of the next attempt
    preAnswers = { q1: "", q2: "", q3: "", q4: "", q5: "", q6: "" };
    postAnswers = { q1: "", q2: "", q3: "", q4: "", q5: "", q6: "", q7: "" };
    photoBase64 = "";
    postQ7Photo = null;
}
